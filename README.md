...
| Employee sees requirements | `documents_for_candidate`: `backend/preonboarding_repository.py:646-713`; UI: `frontend/src/pages/dashboard/Documents.jsx:39-48` |
| Employee uploads file | UI: `frontend/src/pages/dashboard/Documents.jsx:50-75`, `frontend/src/pages/dashboard/Documents.jsx:228-244`; wrapper: `frontend/src/services/api.js:1397-1465` |
| Backend validates/stores file | allowed suffix/content type/max size: `backend/preonboarding_repository.py:15-17`; upload: `backend/preonboarding_repository.py:729-787` |
| HR reviews file | wrapper: `frontend/src/services/api.js:1690-1745`; backend: `backend/preonboarding_repository.py:809-844` |
| Storage | `pre_onboarding_document_requirements`, `pre_onboarding_document_submissions`, `pre_onboarding_audit_logs`, uploaded files in `storage/uploads/documents` |
| Output | Employee sees `uploaded`, `verified`, or `rejected`; HR candidate readiness updates through aggregate builder |
...
| Documents | Required joining docs and HR review | HR requirement fields; employee file uploads | File validation/versioning, HR review, audit trail, aggregate rebuild | `pre_onboarding_document_requirements`, `pre_onboarding_document_submissions`, `storage/uploads/documents` | `backend/app.py:1500-1607`, `frontend/src/services/api.js:1386-1489`, `frontend/src/services/api.js:1918-1952` | Statused document rows | HR sets requirements and approves/rejects | Employee uploads/reuploads and sees status |
